...
# DATA PREPARING
gwiazdka: gpd.GeoDataFrame = gpd.read_file('../.inputs/lines.geojson')

linie_brzegu: list[dict, dict] = [
    {'rok': 2011, 'shoreline': 'in', 'linia_brzegu': gpd.read_file('../.inputs/in_out_geojson/in_2011.geojson')},
    # {'rok': 2011, 'shoreline': 'out', 'linia_brzegu': gpd.read_file('data/out_2011.geojson')},
    {'rok': 2013, 'shoreline': 'in', 'linia_brzegu': gpd.read_file('../.inputs/in_out_geojson/in_2013.geojson')},
    # {'rok': 2013, 'shoreline': 'out', 'linia_brzegu': gpd.read_file('data/out_2013.geojson')},
    {'rok': 2016, 'shoreline': 'in', 'linia_brzegu': gpd.read_file('../.inputs/in_out_geojson/in_2016.geojson')},
    # {'rok': 2016, 'shoreline': 'out', 'linia_brzegu': gpd.read_file('data/out_2016.geojson')},
    {'rok': 2019, 'shoreline': 'in', 'linia_brzegu': gpd.read_file('../.inputs/in_out_geojson/in_2019.geojson')},
    # {'rok': 2019, 'shoreline': 'out', 'linia_brzegu': gpd.read_file('data/out_2019.geojson')},
    {'rok': 2020, 'shoreline': 'in', 'linia_brzegu': gpd.read_file('../.inputs/in_out_geojson/in_2020.geojson')},
    # {'rok': 2020, 'shoreline': 'out', 'linia_brzegu': gpd.read_file('data/out_2020.geojson')},
    {'rok': 2022, 'shoreline': 'in', 'linia_brzegu': gpd.read_file('../.inputs/in_out_geojson/in_2022.geojson')},
